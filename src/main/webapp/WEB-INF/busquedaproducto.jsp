  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="/producto/busqueda">Busqueda de producto</a>
        </li>
      </ul>
      <form class="d-flex">
...
<div class="d-flex justify-content-center">
  ...
  <div class="card-body">
    <h5 class="card-title">Busqueda de producto por nombre</h5>
 ...
 <tbody>
		<c:forEach var="encontrado" items="${listaEncontrados}">		
			<tr>
		      ...
		      <td><c:out value="${encontrado.caracteristica}"></c:out></td>
		      <td><c:out value="${encontrado.precio}"></c:out></td>
		    </tr>
		</c:forEach>
  </tbody>
</table>
